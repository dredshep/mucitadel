...
const UploadMedia = ({
  ...
  //     const croppedImageUrl = await getCroppedImgDataUrl(
  //       imageRef,
  //       crop
  //     );
  //     if (typeof croppedImageUrl === 'string') { // if base64 code
    ...
    <div className={className}>
      ...
      {/* {uploadedFile && 
        <Dialog
          ...
          <Typography variant='h6' className={classes.cropImage}>Crop Image</Typography>
