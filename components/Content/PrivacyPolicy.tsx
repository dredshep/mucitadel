export default function PrivacyPolicy() {
  return (
    <div className="md:max-w-2xl lg:max-w-3xl xl:max-w-6xl mx-3 md:mx-auto text-white-active">
      {/* <p>Privacy Policy - MU</p> */}
      <h1 className="text-4xl flex justify-center mt-10 mb-3 font-title">
        <strong className="flex justify-center">PRIVACY POLICY</strong>
      </h1>
      <p className="flex justify-center mb-10">
        <strong>Last updated April 23, 2021</strong>
      </p>
      <p>
        Thank you for choosing to be part of our community at Memeunity, LLC
        (&quot;<strong>Company</strong>&quot;, &quot;<strong>we</strong>&quot;,
        &quot;<strong>us</strong>&quot;, &quot;<strong>our</strong>&quot;). We
      ...
      <h2
        ...
        id="table-of-contents font-title"
      >
        TABLE OF CONTENTS
      </h2>
      ...
      <h2
        className="text-3xl mt-5 mb-3 font-bold font-title"
        id="2-how-do-we-use-your-information-"
      >
      ...
      <h2
        className="text-3xl mt-5 mb-3 font-bold font-title"
        id="3-will-your-information-be-shared-with-anyone-"
      >
      ...
      <h2
        className="text-3xl mt-5 mb-3 font-bold font-title"
        id="4-is-your-information-transferred-internationally-"
      >
      ...
      <h2
        className="text-3xl mt-5 mb-3 font-bold font-title"
        id="5-how-long-do-we-keep-your-information-"
      >
      ...
      <h2
        className="text-3xl mt-5 mb-3 font-bold font-title"
        id="6-how-do-we-keep-your-information-safe-"
      >
      ...
      <h2
        className="text-3xl mt-5 mb-3 font-bold font-title"
        id="7-do-we-collect-information-from-minors-"
      >
      ...
      <h2
        className="text-3xl mt-5 mb-3 font-bold font-title"
        id="8-what-are-your-privacy-rights-"
      >
      ...
      <h2
        className="text-3xl mt-5 mb-3 font-bold font-title"
        id="9-controls-for-do-not-track-features"
      >
      ...
      <h2
        className="text-3xl mt-5 mb-3 font-bold font-title"
        id="11-do-we-make-updates-to-this-notice-"
      >
