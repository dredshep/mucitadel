  ...
  return (
    <div className="purehtml md:max-w-2xl lg:max-w-3xl xl:max-w-6xl mx-3 md:mx-auto text-white-active">
      ...
      <p className="flex justify-center">
        <strong className="text-white">Last updated April 24, 2021</strong>
      </p>
      <h2 className="text-white text-3xl mt-10 mb-3 font-bold font-title">
        AGREEMENT TO TERMS
      </h2>
      <p>
      ...
      <h2 className="text-white text-3xl mt-5 mb-3 font-bold font-title">
      ...
      <p>
        ...
        Sussex, Delaware, and the Parties hereby consent to, and waive all
      ...
      <ul>
        <li>
          <strong className="text-white">Memeunity, LLC</strong>
        </li>
        <li>
          <strong className="text-white">
        ...
        <li>
          <strong className="text-white">Lewes, DE 19958</strong>
        </li>
        <li>
        ...
        <li>
          ...
          <strong className="text-white">__________</strong>
        </li>
        <li>
          <strong className="text-white">
