...
export default function Legal(props: AuthProps & { slug: string }) {
  ...
  switch (props.slug) {
    ...
    default:
      // if (initialized) {
      return (
        <DefaultElements {...props}>
          <div className="w-full">
            <h1 className="text-4xl text-center font-extrabold">
              404 - You took a wrong turn. This page does not exist.
            </h1>
            <p className="mx-auto text-secondary">If it should exist, please notify us.</p>
          </div>
        </DefaultElements>
      )
    // } else return <p>gay</p>;
